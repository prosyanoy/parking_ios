//
//  ChangePhonenumberNetworkManager.swift
//  Parking
//
...
final class ChangePhonenumberNetworkManager {
    
    static func confirmationRequest(requestType: RequestType, inputNumber: String?, completion: @escaping (String, String) -> Void) {
