...
final class OwnersEntryCellView: UITableViewCell {
...
extension OwnersEntryCellView {
    func configure(with entryCellViewModel: OwnersEntryViewModelProtocol, for indexPath: IndexPath) {
        let cell = entryCellViewModel.getOwnerEntryViewModel(for: indexPath)
